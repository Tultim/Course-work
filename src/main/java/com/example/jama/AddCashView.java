...
public class AddCashView {
    ...
    void initialize() {
        ...
        reference_button.setOnAction(actionEvent -> {
            ...
            alert.setTitle("Der Auskunft.");
            alert.setHeaderText(null);
            alert.setContentText("Kassiererin - Tulekeyev Temirlan\" +\n" +
                    "                    \"№1 S. Bischkek, St. Maldybaeva 20.12.2021.");
            alert.showAndWait();
        });
        ...
        submit_button.setOnAction(actionEvent -> {
            if(!sum_field.getText().equals("") && (kgs_radio.isSelected() || rub_radio.isSelected() ||
                ...
                try {
                    ...
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setTitle("Bereit.");
                    alert.setHeaderText(null);
                    alert.setContentText("Kasse erfolgreich aktualisiert.");
                    alert.showAndWait();
